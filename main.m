function [fitness_gen, fitness_pop] = main()
    ...
    for i = 1:populationSize/2
        ...
        [offspring(2*i-1,:), offspring(2*i,:)] = arithmetic_recombination(population(parentIndexes(1),:), population(parentIndexes(2),:), recombination_weight);
    end
    % Mutation
    %% TODO
